angular.module('SkateSpots', ['SkateSpots.services', 'SkateSpots.filters', 'SkateSpots.directives'])
	.config(['$routeProvider', function($routeProvider) {
		$routeProvider.
			...
			when('/logout', {templateUrl: 'src/templates/login.html', controller: LogoutCtrl}).
			when('/user/create', {templateUrl: 'src/templates/user-form.html', controller: UserCreateCtrl}).
			when('/user/update/:id', {templateUrl: 'src/templates/user-update.html', controller: UserUpdateCtrl}).
			when('/user/list', {templateUrl: 'src/templates/user-list.html', controller: UserListCtrl}).
			when('/user/show/:id', {templateUrl: 'src/templates/user-show.html', controller: UserShowCtrl}).
			when('/spot/list', {templateUrl: 'src/templates/spot-list.html', controller: SpotListCtrl}).
			when('/spot/show/:id', {templateUrl: 'src/templates/spot-show.html', controller: SpotShowCtrl}).
			when('/spot/create', {templateUrl: 'src/templates/spot-create.html', controller: SpotCreateCtrl}).
			when('/picture/create/:controller/:method/:id', {templateUrl: 'src/templates/picture-create.html', controller: PictureCreateCtrl}).
	...
	var CryptoJS = CryptoJS||function(e,m){var p={},j=p.lib={},l=function(){},f=j.Base={extend:function(a){l.prototype=this;var c=new l;a&&c.mixIn(a);c.hasOwnProperty("init")||(c.init=function(){c.$super.init.apply(this,arguments)});c.init.prototype=c;c.$super=this;return c},create:function(){var a=this.extend();a.init.apply(a,arguments);return a},init:function(){},mixIn:function(a){for(var c in a)a.hasOwnProperty(c)&&(this[c]=a[c]);a.hasOwnProperty("toString")&&(this.toString=a.toString)},clone:function(){return this.init.prototype.extend(this)}},
		...
		$rootScope.Crypto = CryptoJS;
		
	$rootScope.util = {};
	$rootScope.util.needArray = function(object){
	...
	$rootScope.util.getUserPosition = function(callbackSucess, callbackFailed){
		if(navigator.geolocation){
			navigator.geolocation.getCurrentPosition(function(position) {
				...
				callbackFailed($rootScope.i18n.get('gps.position.error'));
			});
		}else{
